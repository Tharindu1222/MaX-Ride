...
// Persist into local.properties so IDEs / re-builds see the key
...
if (mapsApiKey.isBlank()) {
    logger.warn(
        "GOOGLE_MAPS_API_KEY is empty. Set it in apps/api/.env or environment."
    )
} else {
...
android {
    namespace = "com.maxride.passenger_app"
    ...
    defaultConfig {
        applicationId = "com.maxride.passenger_app"
